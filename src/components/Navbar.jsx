    ...
    <header className="navbar h-[100px] px-[25px] md:px-[40px] lg:px-[50px] flex justify-between items-center text-theme-lightest-slate font-sfMonoRegular z-[100]">
      <nav className="w-full  flex flex-row justify-between items-center">
        <motion.div
          ...
          className="my-auto cursor-pointer min-w-[43px]  "
        >
          <Link
            to="hero"
            spy={true}
          ...
          >
            ...
            >
              ...
              <motion.path
                ...
                strokeWidth="5"
                d="M50 5L11 27v45l39 23 39-22V28z"
              ></motion.path>
            </svg>
          </Link>
        </motion.div>
        <motion.div
          className="hidden sm:flex flex-row text-[13px] "
          initial="initial"
          animate="end"
        ...
        >
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              offset={0}
              duration={500}
              className="  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
          ...
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              className="  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <span className="text-theme-green">03. </span> Experience
            </Link>
          </motion.div>
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              className="  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <span className="text-theme-green">04. </span> Projects
            </Link>
          </motion.div>
          <motion.div className="p-[10px]" variants={childVariants}>
            <Link
              ...
              className="  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <span className="text-theme-green">05. </span> Contact
            </Link>
          </motion.div>
          <motion.div
            className="resume ml-4  border border-theme-green hover:bg-theme-green/10 cursor-pointer rounded flex items-center text-theme-green"
          ...
          >
            <a
              ...
              href={resume}
              rel="noreferrer"
              className="px-[16px] py-[12px] line"
            >
              Resume
            </a>
          </motion.div>
        ...
        <aside className="drawer drawer-hidden" ref={drawerRef}>
          <div className="flex-row text-[16px] ">
            ...
            >
              <div className="text-theme-green ">01. </div>{" "}
            ...
            <Link
              ...
              className="p-[10px] flex flex-col justify-center  items-center  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <div className="text-theme-green ">02. </div>{" "}
            ...
            <Link
              ...
              className="p-[10px] flex flex-col justify-center  items-center  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <div className="text-theme-green ">03. </div>{" "}
            ...
            <Link
              ...
              className="p-[10px] flex flex-col justify-center  items-center  font-poppins mx-1 cursor-pointer hover:text-theme-green"
            >
              <div className="text-theme-green ">04. </div>{" "}
