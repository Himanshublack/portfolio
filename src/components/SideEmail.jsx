...
function SideEmail() {
	return (
		<motion.div className="hidden md:flex flex-col items-center fixed bottom-0 md:right-5 lg:right-8 min-w-[40px]  social-line" initial="initial" animate="end" variants={startVariants}>
			<a href="mailto:himanshfication05@hotmail.com" target="_blank" rel="noreferrer" className="email social-icon-box text-theme-light-slate font-sfMonoRegular text-[12px] mb-6 p-2">
				Mail
			</a>
		</motion.div>
	);
