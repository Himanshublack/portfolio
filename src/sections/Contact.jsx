    ...
    >
      ...
      <div className="flex flex-col md:flex-row align-middle min-h-full text-[20px] font-calibreRegular text-theme-gray-deep font-medium ">
        <div className="">
          <p className="mb-4 text-center text-[18px]">
            I am actively seeking internship opportunities in AI/ML development and research roles.
            If you are looking to hire or just want to say Hi, my
            inbox is always open and happy to hear from you.I always get an acknowledgment for my side.
          </p>
        </div>
      </div>
      <div className="w-fit mt-9 border border-theme-green hover:bg-theme-green/10 cursor-pointer rounded flex  items-center text-theme-green">
        <a
          target="_blank"
          rel="noreferrer"
          href="mailto:himanshfiction05@hotmail.com"
